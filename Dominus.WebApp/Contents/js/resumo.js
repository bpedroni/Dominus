...
$(document).ready(function () {
    ...
    if (_transacoes.length > 0) {
        ...
        $dominusChart.createColumnChart($('#chartReceitas')[0], 'Receitas no mês', $dominusChart.groupData(receitas, 'Categoria', 'Valor'), ["#023e8a", "#0077b6", "#03045e", "#0096c7", "#00b4d8", "#48cae4", "#90e0ef", "#ade8f4", "#caf0f8", "#f94144", "#f3722c", "#f8961e", "#f9844a", "#f9c74f", "#90be6d", "#43aa8b", "#4d908e", "#577590", "#277da1"], false);
